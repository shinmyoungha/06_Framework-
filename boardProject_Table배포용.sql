...
-- 암호회된 비밀번호(평문 : pass01!) 업데이트
UPDATE "MEMBER" SET
MEMBER_PW ='$2a$10$z47.HL3Y9Awi93/cj6HOt.QD4dqPGrFxqk69gOLGSLQaTykhy/Z4q'
WHERE MEMBER_NO =2;
...
AUTHORITY,
TO_CHAR(ENROLL_DATE, 'YYYY"년" MM"월" HH24"시" MI"분" SS"초"') ENROLL_DATE
FROM "MEMBER"
...
-- 게시글번호/제먹[댓글개수]/작성자닉네임/작성일/조회수/좋아요 개수
