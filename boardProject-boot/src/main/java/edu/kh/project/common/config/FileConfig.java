...
public class FileConfig implements WebMvcConfigurer {
   ...
   private String profileResourceHaandler; // /myPage/profile/**
   
   @Value("${my.profile.resources-location}")
   ...
   public void addResourceHandlers(ResourceHandlerRegistry registry) {
	   ...
	   registry
	   .addResourceHandler(profileResourceHaandler) // /myPage/profile/**
   ...
   // -> Bean 으로 등록하면서 위에서 만든 MultipartConfigElement 자동으로 이용함
   @Bean
