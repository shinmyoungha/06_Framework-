...
public class MyPageController {
	 ...
	 * @param loginMember : 세션에 저장된 현재 로그인한 회원 정보
	 * @param ra
	 * @return
	 */
	...
	public String secssion(@RequestParam("memberPw") String memberPw,
