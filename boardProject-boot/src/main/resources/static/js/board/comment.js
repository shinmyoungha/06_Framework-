...
// 댓글 등록 (ajax) 대댓글 등록도 같이 할거임
const commentContent = document.querySelector("#commentContent"); // textarea
const addComment = document.querySelector("#addComment"); // botton
...
const showInsertComment = (parentCommentNo, btn) => {
    ...
    // 매개변수에 + 문자열 + 작성 시 Number 타입으로 형변환
